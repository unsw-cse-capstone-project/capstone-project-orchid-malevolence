# Generated by Django 3.0.7 on 2020-07-11 03:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('averageRating', models.DecimalField(decimal_places=2, max_digits=5, null=True)),
        ...
        migrations.AddField(
            model_name='book',
            name='collection',
            field=models.ManyToManyField(related_name='col_book', through='backed.Collection_Book', to='backed.Collection'),
        ),
        migrations.CreateModel(
            name='Rating',
            fields=[
